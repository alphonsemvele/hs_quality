...
return new class extends Migration
{
    ...
    {
        Schema::create('intervention_signatures', function (Blueprint $table) {
            ...
            $table->string('path');
            // 'beneficiary' or 'intervenant'
            $table->string('signer_type', 30);
    ...
    {
        Schema::dropIfExists('intervention_signatures');
    }
};
