...
# Database subnets — RDS + ElastiCache (isolated from internet)
...
# NAT gateways — one per AZ for HA (production); one for staging cost savings
...
resource "aws_security_group" "database" {
  ...
  description = "PostgreSQL + Redis access from private subnets only"
  vpc_id      = aws_vpc.main.id
